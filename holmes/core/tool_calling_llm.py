    ...
    def call_stream(
        ...
        while i < max_steps:
            ...
            try:
                ...
                if otel_metrics:
                    ...
                    if response_stats.prompt_tokens > 0:
                        otel_metrics.llm_input_tokens.add(response_stats.prompt_tokens, {**model_attrs, "gen_ai_token_type": "input"})
                    if response_stats.completion_tokens > 0:
                        otel_metrics.llm_input_tokens.add(response_stats.completion_tokens, {**model_attrs, "gen_ai_token_type": "output"})
            ...
            # catch a known error that occurs with Azure and replace the error message with something more obvious to the user
                ...
                # End the gen_ai.chat span so that subsequent tool call spans
                # become siblings, not children
                llm_span.end()
